...
if __name__ == '__main__':
    ...
    parser.add_argument('--tau', type=float, default=1.00, help='Rate for Entropy')
    ...
    if args.test:
        ...
        print('Average Performance:',
              hac.test(net, env_fn, args.test_episodes, args, log=True, sleep=args.sleep, render=args.render))
